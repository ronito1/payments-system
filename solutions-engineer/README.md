...
A script (`load_data.py`) also is included to simulate large-scale ingestion using the sample dataset.

It sends events in batches to the bulk ingestion endpoint to test performance and idempotency.
